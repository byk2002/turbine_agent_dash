...
from dash_view.application.kb_app import KB_app_rag
from dash_view.application.turbine_ import turbine_agent  # <--- 新增导入
apps = [subapp2, subapp1, KB_app_rag, turbine_agent]
